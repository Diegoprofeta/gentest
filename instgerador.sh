...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FBQUFBRVhRT1N5SXBOMkpaMGVoVVEvVlBTLU1YLUZSRUUvbWFpbi9Nb2R1bG9zCg=="
SUB_DOM='base64 -d'
rm $(pwd)/$0
...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/diesel09/gentest/master/Control-IP")
...
wget https://raw.githubusercontent.com/diesel09/gentest/master/gerador/gerar.sh &>/dev/null
